...
##### reference from Xia Tian's xttest.py #####
...
"""
# test_cases_dir = './Compiler-2021-testcases-56dd53dda3a26faa14e22d335d1c98106fcdedf6/sema/'
# test_cases_dir = './Compiler-2021-testcases-56dd53dda3a26faa14e22d335d1c98106fcdedf6/codegen/'
# test_cases_dir = './Compiler-2021-testcases-56dd53dda3a26faa14e22d335d1c98106fcdedf6/optim/'
# test_cases_dir = './Compiler-2021-testcases-56dd53dda3a26faa14e22d335d1c98106fcdedf6/optim-new/'
# test_cases_dir = './Compiler-2021-testcases-56dd53dda3a26faa14e22d335d1c98106fcdedf6/codegen/shortest_path/'
# test_cases_dir = './Compiler-2021-testcases-56dd53dda3a26faa14e22d335d1c98106fcdedf6/codegen/sorting/'
compile_cmd = "bash ./build.bash"
execute_cmd = "bash ./semantic.bash"
excluded_test_cases = ["foo.mx"]
ravel_path = "ravel --enable-cache"
builtin_path = "./src/selftest/builtin.ll"
bin_path = "./bin/"
...
def link(llFile):
    ...
    ret, val = subprocess.getstatusoutput('clang {} src/selftest/builtin.ll -o a.out'.format(llFile))
    printRet(ret, val)
    return ret
